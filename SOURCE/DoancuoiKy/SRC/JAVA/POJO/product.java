...
public class product {
    ...
    public product(int idp, String namep, int categoryp, double pricep, String imgfilep, String descp, String detailp, String publishp, String hotp, String sttp, String keysearchp, int viewp, Timestamp datep, int storep) {
        this.idp = idp;
        this.namep = namep;
    ...
    public void setStorep(int storep) {
        this.storep = storep;
    }
